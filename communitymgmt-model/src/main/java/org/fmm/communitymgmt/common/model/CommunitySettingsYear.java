 ...
 */
@Entity
@IdClass (CommunitySettingsYearPK.class)
public class CommunitySettingsYear implements Serializable {
	...
	@Id
	@Column(name="year") //-> Da error diciendo que se use @PrimaryKeyJoinColumn
